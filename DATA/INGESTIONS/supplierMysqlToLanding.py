...
GCS_BUCKET = "retailer-datalke-project"
...
BQ_PROJECT = "pivotal-bolt-473013-k5"
...
# MySQL Configuration
MYSQL_CONFIG = {
    "url" : "jdbc:mysql://34.45.138.172:3306/supplierDB?useSSL=false&allowPublicKeyRetrieval=true",
    "driver": "com.mysql.cj.jdbc.Driver",
    "user": "myuser",
    "password": "Lannister@1010"
}
...
def move_existing_files_to_archive(table):
    ...
    blobs = list(storage_client.bucket(GCS_BUCKET).list_blobs(prefix=f"landing/supplier-db/{table}/"))
    # FIX 2: Check if file name ends with .json AND is not a directory/folder itself
    existing_files = [blob.name for blob in blobs if blob.name.endswith(".json")]
